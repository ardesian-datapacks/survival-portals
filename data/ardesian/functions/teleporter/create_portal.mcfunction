...
# --connect
execute at @s run execute as @e[tag=zPortal,tag=!PortalLocationSet,distance=..1] at @s if data entity @e[distance=..1,sort=nearest,limit=1,nbt={OnGround:1b,Item:{id:"minecraft:ender_eye",tag:{PortKey:1b}}}] Thrower.L run function ardesian:teleporter/connect_portal
